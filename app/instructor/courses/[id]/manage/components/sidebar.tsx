          ...
          return (
            <div key={id}>
              ...
              {section.links.map((link, id) => {
                const isActive = pathname === `/instructor/courses/2323/manage/${link.link}`;
                return (
                  <Link
                    className={`flex items-center px-2 py-1 text-gray-600 rounded-md ${isActive ? 'bg-gray-200' : 'hover:bg-gray-50'}`}
