  ...
  return (
    <div>
      <div className="mt-6 mb-6 space-y-4">
        <h2 className="text-xl font-bold text-gray-900">Arrange your ideal studio and get early feedback</h2>
      ...
      <div className="mt-6 mb-6 space-y-4">
        ...
        <p className="mt-2 text-l text-gray-600">
          <strong>Equipment can be easy.</strong><br />
        ...
        <p className="mt-2 text-l text-gray-600">
          <strong>Students need to hear you.</strong><br />
        ...
        <p className="mt-2 text-l text-gray-600">
          <strong>Make a studio.</strong><br />
        ...
        <p className="mt-2 text-l text-gray-600">
          <strong>Light the scene and your face.</strong><br />
        ...
        <p className="mt-2 text-l text-gray-600">
          <strong>Reduce noise and echo.</strong><br />
