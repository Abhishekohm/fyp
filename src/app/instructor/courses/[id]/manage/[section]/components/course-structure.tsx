  ...
  return (
    <div className="bg-white p-6 rounded-md shadow">
      ...
      <div className="mt-6 mb-6 space-y-4">
        ...
        <p className="mt-2 text-l text-gray-600">
          <strong>Start with your goals.</strong>
          <br />
        ...
        <p className="mt-2 text-l text-gray-600">
          <strong>Create an outline.</strong>
          <br />
        ...
        <p className="mt-2 text-l text-gray-600">
          <strong>Introduce yourself and create momentum.</strong>
          <br />
        ...
        <p className="mt-2 text-l text-gray-600">
          <strong>Sections have a clear learning objective.</strong>
          <br />
        ...
        <p className="mt-2 text-l text-gray-600">
          <strong>Lectures cover one concept.</strong>
          <br />A good lecture length is 2-7 minutes to keep students interested
        ...
        <p className="mt-2 text-l text-gray-600">
          <strong>Practice activities create hands-on learning.</strong>
          <br />
