  ...
  return (
    <div>
      ...
      <div className="mt-6 mb-6 space-y-4">
        ...
        <p className="mt-2 text-l text-gray-600">
          <strong>Take breaks and review frequently.</strong>
          <br />
        ...
        <p className="mt-2 text-l text-gray-600">
          <strong>Create audio marks.</strong>
          <br />
        ...
        <p className="mt-2 text-l text-gray-600">
          <strong>For screencasts, clean up.</strong>
          <br />
