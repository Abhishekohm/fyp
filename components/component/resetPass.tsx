...
//     e.preventDefault();
//     // Logic to handle form submission (e.g., sending reset email)
//     // Once the form is submitted, close the dialog
//     onClose();
//   };
...
//       <div className="bg-opacity-50" />
//       <DialogContent className="p-0">
//         <Card as="form" className="w-[400px]" onSubmit={handleFormSubmit}>
//           <CardHeader className="p-4">
//             <CardTitle className="text-2xl font-bold">Forgot Password</CardTitle>
//             <CardDescription>Enter your email to reset your password</CardDescription>
//             <Button className="absolute top-2 right-2" variant="transparent" onClick={handleClose}>X</Button> {/* Close button */}
//           </CardHeader>
//           <CardContent className="p-4">
//             <div className="space-y-4">
//               <div className="space-y-2">
//                 <Label htmlFor="username">Email</Label>
//                 <Input id="username" placeholder="m@example.com" required type="email" value={email} onChange={(e) => setEmail(e.target.value)} />
//               </div>
